...
public class RabbitTemplateConfig {
    ...
    private Logger LOGGER = LoggerFactory.getLogger("rabbit");
    ...
    public RabbitTemplate customRabbitTemplate(ConnectionFactory connectionFactory){
        ...
        rabbitTemplate.setConfirmCallback((correlationData,ack,cause)->{
           ...
           // RabbitMetaMessage metaMessage =  (RabbitMetaMessage)redisTemplate.opsForHash().get(MQConstants.MQ_PRODUCER_RETRY_KEY, cacheKey);
            //如果消息正确投递
            System.out.println("SUCESS_SEND的值是："+SUCESS_SEND);
            if (ack) {
        ...
        LOGGER.info("RabbitTemplate实例化完成");
    ...
    public void reSendMsg(String msgId, RabbitMetaMessage rabbitMetaMessage) {
        ...
        Retryer<Boolean> retryer = RetryerBuilder
                ...
                .withWaitStrategy(WaitStrategies.exponentialWait(MQConstants.MUTIPLIER_TIME, MQConstants.MAX_RETRY_TIME, TimeUnit.SECONDS))
